...
ax = imagesc(direct_sw_epic_zonal(:,time_filter) + diffuse_sw_epic_zonal(:,time_filter), [0 500])
title('(a) EPIC - SW')
set(gca,'xtick',[], 'ytick', [1 900 1800], 'yticklabel',{'90буN','0бу','90буS'});
subplot('position',[0.5 0.55 0.4 0.38])
imagesc(direct_sw_ceres_zonal(:,time_filter) + diffuse_sw_ceres_zonal(:,time_filter), [0 500])
title('(b) CERES - SW')
set(gca,'xtick',[], 'ytick', [1 900 1800], 'yticklabel',{'90буN','0бу','90буS'});
...
imagesc(direct_par_epic_zonal(:,time_filter) + diffuse_par_epic_zonal(:,time_filter), [0 200])
title('(c) EPIC - PAR')
set(gca,'xtick',[], 'ytick', [1 900 1800], 'yticklabel',{'90буN','0бу','90буS'});
...
imagesc(direct_par_ceres_zonal(:,time_filter) + diffuse_par_ceres_zonal(:,time_filter), [0 200])
title('(d) CERES - PAR')
set(gca,'xtick',[202 568 933 1298], 'xticklabel',{'1/1/2016', '1/1/2017', '1/1/2018', '1/1/2019'}...
    , 'ytick', [1 900 1800], 'yticklabel',{'90буN','0бу','90буS'});
set(gca,'TickDir','out', 'box', 'off'); % The only other option is 'in'
...
print(gcf, '-dtiff', '-r600', 'zonal_variation.tif')

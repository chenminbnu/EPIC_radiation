function plot_spatial_distribution_RMSE_hourly(RMSE, titletext, savefilename)
%%get site location
Directory = '';
...
%setm(gca, 'title', 'aaaa')
axis off
lg1 = legend([p1 p2 p3 p4 p5],{'<70', '70-90', '90-110', '110-130','>130'},...

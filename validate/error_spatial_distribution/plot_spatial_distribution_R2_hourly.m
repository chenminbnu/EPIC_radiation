function plot_spatial_distribution_R2_hourly(R2, titletext, savefilename)
%%get site location
Directory = '';
...
%setm(gca, 'title', 'aaaa')
axis off
lg1 = legend([p1 p2 p3 p4 p5],{'<0.75', '0.75-0.80', '0.80-0.85', '0.85-0.90','>0.90'},...

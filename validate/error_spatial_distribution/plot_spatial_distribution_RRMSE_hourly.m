function plot_spatial_distribution_RRMSE_hourly(RRMSE, titletext, savefilename)
%%get site location
Directory = '';
...
%setm(gca, 'title', 'aaaa')
axis off
lg1 = legend([p1 p2 p3 p4 p5],{'<20', '20-30', '30-40', '40-50','>50'},...

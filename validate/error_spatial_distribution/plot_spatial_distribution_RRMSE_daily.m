function plot_spatial_distribution_RRMSE_daily(RRMSE, titletext, savefilename)
%%get site location
Directory = '';
...
%setm(gca, 'title', 'aaaa')
axis off
lg1 = legend([p1 p2 p3 p4 p5 p6],{'<10', '10-15', '15-20', '20-25', '25-30','>30'},...

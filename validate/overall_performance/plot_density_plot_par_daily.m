function plot_density_plot_par_daily(obs,estimate,x_text, y_text, title_text)
obs0 = obs;
estimate0 = estimate;
...
text(10,190,['Bias = ' num2str(Bias,'%.2f')],'FontSize',9, 'FontWeight', 'Bold');
%text(15,450,['MAE = ' num2str(MAE,'%.2f')],'FontSize',9);
text(10,177,['RMSE = ' num2str(RMSE,'%.2f')],'FontSize',9, 'FontWeight', 'Bold');
text(10,164,['RRMSE = ' num2str(RRMSE,'%.2f') '%'],'FontSize',9, 'FontWeight', 'Bold');

text(10,149,['R^2 = ' num2str(R2,'%.2f')],'FontSize',9, 'FontWeight', 'Bold');
...
set(gca,'FontSize',10,'Linewidth',2, 'xTick', 0:100:200, 'xTicklabel', 0:100:200, ...
    'yTick', 0:100:200, 'yTicklabel', 0:100:200);

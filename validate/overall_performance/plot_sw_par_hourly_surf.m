...
subplot(2,2,1)
plot_density_plot_SW_hourly(obs_total, epic_total,'The observed','EPIC','Total SW');
subplot(2,2,2)
plot_density_plot_SW_hourly(obs_direct, epic_direct,'The observed','EPIC','Direct SW');
subplot(2,2,3)
plot_density_plot_SW_hourly(obs_diffuse, epic_diffuse,'The observed','EPIC','Diffuse SW');
subplot(2,2,4)
plot_density_plot_par_hourly(obs_par, epic_par,'The observed','EPIC','Total PAR');

...
hold on
obs_clear = nanmean(sw_total_obs(:,skyconditions == 0), 2);
epic_clear = nanmean(sw_total_epic(:,skyconditions == 0), 2);
obs_cloudy = nanmean(sw_total_obs(:,skyconditions == 1), 2);
epic_cloudy = nanmean(sw_total_epic(:,skyconditions == 1), 2);
obs_overcast = nanmean(sw_total_obs(:,skyconditions == 2), 2);
epic_overcast = nanmean(sw_total_epic(:,skyconditions == 2), 2);
...
%% save file
print(gcf, '-dtiff', '-r600', 'total_sw.tif')
